...
6. **Resting ECG** - 3 categories (0-2)
7. **Maximum Heart Rate** - Achieved during exercise
8. **Exercise Induced Angina** - Yes (1) or No (0)
9. **ST Depression** - Oldpeak value
10. **ST Slope** - 3 categories (0-2)
11. **Major Vessels** - Number colored by fluoroscopy (0-4)
12. **Thalassemia** - 3 categories (0-2)
